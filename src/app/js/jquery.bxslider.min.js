    ...
    var a = t(window).width(),
      ...
      c = function() {
        r.wrap('<div class="bx-wrapper"><div class="bx-viewport"></div></div>'),
          ...
          'fade' == o.settings.mode &&
            (o.children.css({position: 'absolute', zIndex: 0, display: 'none'}), o.children.eq(o.settings.startSlide).css({zIndex: o.settings.slideZIndex, display: 'block'})),
      ...
      A = function(t) {
        o.settings.autoControlsCombine
          ...
          : (o.controls.autoEl.find('a').removeClass('active'), o.controls.autoEl.find('a:not(.bx-' + t + ')').addClass('active'));
      },
      W = function() {
        1 == x()
